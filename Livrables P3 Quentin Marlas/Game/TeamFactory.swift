...
class TeamFactory {
    ...
    private func createCharacters() -> [Character] { // Place each character in a array named Character
    ...
    private func createTeam() -> Team { // Use the array to create a team
